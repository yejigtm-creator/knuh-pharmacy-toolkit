...
const EDUCATION_DRUGS: Record<EducationMode, string[]> = {
  ...
  colonoscopy: ["수클리어산", "오라팡정", "원프렙 1.38산", "플렌뷰산", "피코솔루션액", "하프렙산", "제이클정"].sort((a, b) => a.localeCompare(b, "ko")),
};
...
const PATIENT_EDUCATION_PDFS: Record<EducationMode, PatientEducationItem[]> = {
  ...
  colonoscopy: [
    ...
    { id: "colonoscopy-orapang", drugName: "오라팡정", fileName: "오라팡정.pdf", pdfData: "/patient-education/colonoscopy/오라팡정.pdf?v=f61fc1568c67" },
    { id: "colonoscopy-jaycle", drugName: "제이클정", fileName: "제이클정.pdf", pdfData: "/patient-education/colonoscopy/제이클정.pdf" },
