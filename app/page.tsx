...
function ResultBox({ label, value }: { label: string; value: string }) {
  return <div><div className="text-sm text-[#6e665b]">{label}</div><div className="text-xl font-semibold text-[#3f372f]">{value}</div></div>;
}
